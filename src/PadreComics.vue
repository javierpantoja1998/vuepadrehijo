<template>
  <div>
    <h1 style="color:antiquewhite; background-color:darkolivegreen">Padre Comics</h1>
    <div v-if="comicFavorito" style="background-color: darkcyan;">
    ...
    <div id="comics" v-for="(comic,index ) in comics" :key="comic">
      <HijoComics :comic="comic" :index="index"
...
export default {
  ...
  methods: {
    ...
    eliminarComic(index){
        //El unico indica la cantidad de elementos que queremos eliminar
        this.comics.splice(index,1);
    }
  },
  data() {
    //Nos creamos un objeto Comic
    return {
    comicFavorito:null,
      comicForm: {
        titulo: "",
